...
const TRAVEL_MATRIX = {
    // --------------------------------------------------------------------
    // I. メインエリア 46x46 マトリクス (旅費の距離・金額.csv から抽出)
    // --------------------------------------------------------------------
    "本渡": {
